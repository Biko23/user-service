...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleNotFoundException(CustomNotFoundException customNotFoundException, WebRequest webRequest) {
        ...
        return new ResponseEntity<>(new ApiResponseFormat(false, new ErrorFormat(HttpStatus.NOT_FOUND.value(), "Entity not found.", webRequest.getDescription(false)), customNotFoundException.getMessage(), null), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> handleNoContentException(CustomNoContentException customNoContentException, WebRequest webRequest) {
        ...
        return new ResponseEntity<>(new ApiResponseFormat(false, new ErrorFormat(HttpStatus.NOT_FOUND.value(), "Entities not found.", webRequest.getDescription(false)), customNoContentException.getMessage(), null), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> handleInvalidInputException(CustomInvalidInputException customInvalidInputException, WebRequest webRequest) {
        ...
        return new ResponseEntity<>(new ApiResponseFormat(false, new ErrorFormat(HttpStatus.BAD_REQUEST.value(), "Invalid input provided.", webRequest.getDescription(false)), customInvalidInputException.getMessage(), null), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> handleEmptyInputException(CustomEmptyInputException customEmptyInputException, WebRequest webRequest) {
        ...
        return new ResponseEntity<>(new ApiResponseFormat(false, new ErrorFormat(HttpStatus.BAD_REQUEST.value(), "Empty input provided.", webRequest.getDescription(false)), customEmptyInputException.getMessage(), null), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> handleAlreadyExistsException(CustomAlreadyExistsException customAlreadyExistsException, WebRequest webRequest) {
        ...
        return new ResponseEntity<>(new ApiResponseFormat(false, new ErrorFormat(HttpStatus.CONFLICT.value(), "Entity already exists.", webRequest.getDescription(false)), customAlreadyExistsException.getMessage(), null), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> handleNumberFormatException(CustomNumberFormatException customNumberFormatException, WebRequest webRequest) {
        ...
        return new ResponseEntity<>(new ApiResponseFormat(false, new ErrorFormat(HttpStatus.CONFLICT.value(), "Entity already exists.", webRequest.getDescription(false)), customNumberFormatException.getMessage(), null), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> handleJsonPatchException(CustomJsonPatchException customJsonPatchException, WebRequest webRequest) {
        ...
        return new ResponseEntity<>(new ApiResponseFormat(false, new ErrorFormat(HttpStatus.INTERNAL_SERVER_ERROR.value(), "Json patch internal server error.", webRequest.getDescription(false)), customJsonPatchException.getMessage(), null), HttpStatus.INTERNAL_SERVER_ERROR);
    }
    ...
    public ResponseEntity<?> handleJsonProcessingException(CustomJsonProcessingException customJsonProcessingException, WebRequest webRequest) {
        ...
        return new ResponseEntity<>(new ApiResponseFormat(false, new ErrorFormat(HttpStatus.INTERNAL_SERVER_ERROR.value(), "Json processing internal server error.", webRequest.getDescription(false)), customJsonProcessingException.getMessage(), null), HttpStatus.INTERNAL_SERVER_ERROR);
    }
    ...
    public ResponseEntity<?> handleJwtAccessTokenExpiredException(CustomJwtAccessTokenExpiredException customJwtAccessTokenExpiredException, WebRequest webRequest) {
        ...
        return new ResponseEntity<>(new ApiResponseFormat(false, new ErrorFormat(HttpStatus.BAD_REQUEST.value(), "JWT Access Token expired.", webRequest.getDescription(false)), customJwtAccessTokenExpiredException.getMessage(), null), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> handleJwtAccessTokenStillValidException(CustomJwtAccessTokenStillValidException customJwtAccessTokenStillValidException, WebRequest webRequest) {
        ...
        return new ResponseEntity<>(new ApiResponseFormat(false, new ErrorFormat(HttpStatus.CONFLICT.value(), "JWT Access Token still valid.", webRequest.getDescription(false)), customJwtAccessTokenStillValidException.getMessage(), null), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> handleJwtRefreshTokenExpiredException(CustomJwtRefreshTokenExpiredException customJwtRefreshTokenExpiredException, WebRequest webRequest) {
        ...
        return new ResponseEntity<>(new ApiResponseFormat(false, new ErrorFormat(HttpStatus.BAD_REQUEST.value(), "JWT Refresh Token expired.", webRequest.getDescription(false)), customJwtRefreshTokenExpiredException.getMessage(), null), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> handleJwtRefreshTokenStillValidException(CustomJwtRefreshTokenStillValidException customJwtRefreshTokenStillValidException, WebRequest webRequest) {
        ...
        return new ResponseEntity<>(new ApiResponseFormat(false, new ErrorFormat(HttpStatus.CONFLICT.value(), "JWT Refresh Token still valid.", webRequest.getDescription(false)), customJwtRefreshTokenStillValidException.getMessage(), null), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> handleJwtInvalidAccessTokenException(CustomJwtAccessTokenInvalidException customJwtAccessTokenInvalidException, WebRequest webRequest) {
        ...
        return new ResponseEntity<>(new ApiResponseFormat(false, new ErrorFormat(HttpStatus.BAD_REQUEST.value(), "JWT Access Token not valid.", webRequest.getDescription(false)), customJwtAccessTokenInvalidException.getMessage(), null), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> handleNotAuthorisedException(CustomNotAuthorisedException customNotAuthorisedException, WebRequest webRequest) {
        ...
        return new ResponseEntity<>(new ApiResponseFormat(false, new ErrorFormat(HttpStatus.UNAUTHORIZED.value(), "Request not authorised.", webRequest.getDescription(false)), customNotAuthorisedException.getMessage(), null), HttpStatus.OK);
    }
